...
`
  },
  {
    ...
    summary:"연세대학교 창업보육센터 초청으로 창업동아리 학생들을 만나는 하루 특강입니다. "
        + "아이디어 검증부터 브랜딩 · 콘텐츠 · 운영까지, 창업의 각 단계에서 AI 를 어떻게 쓰면 좋은지 실무 방식 그대로 다룹니다. 홈페이지에서 따로 신청받지 않습니다.",
    sessions:[
    ...
    detail:`
## 초청 특강입니다
**연세대학교 창업보육센터**의 요청으로 **창업동아리** 학생들을 위해 진행하는 특강입니다.
홈페이지에서 신청받는 강의가 아니라, 초청을 받아 나가는 자리입니다.

## 무엇을 다루나
특정 도구 하나가 아니라, **창업하는 과정 전체에서 AI 를 쓰는 법**을 다룹니다.
- **아이디어와 고객 검증** — AI 와 함께 시장을 조사하고 고객을 좁히는 법
- **브랜드와 콘텐츠** — 우리 브랜드의 말투와 이미지를 AI 로 일관되게 만드는 법
- **운영과 자동화** — 반복 업무를 AI 에게 맡기고 대표는 판단에 집중하는 구조
- **AI 를 쓰는 태도** — 결과를 그대로 믿지 않고 검토하는 습관

작은 브랜드를 직접 운영하며 매일 AI 와 일하는 실무자의 방식 그대로 전합니다.
...
## 학교 · 기관 특강을 원하시면
학과 · 창업보육센터 · 기관 단위로 따로 요청하실 수 있습니다. 대상과 원하시는 주제를 알려주시면
일정을 맞춰 보겠습니다.
`
  },
  {
    id:"sju-culture", title:"생성형 AI 시대, 콘텐츠 실무와 창업", edition:"",
    status:"auto", kind:"invite",
    host:"상지대학교 문화콘텐츠학과 초청 특강",
    summary:"상지대학교 문화콘텐츠학과 학생들을 대상으로 하는 초청 특강입니다. "
        + "지금 현업에서 생성형 AI 로 콘텐츠를 어떻게 만들고, AI 를 활용해 어떻게 창업하고 일하는지 실무 경험으로 나눕니다. 홈페이지에서 따로 신청받지 않습니다.",
    sessions:[
      {date:"2026-10-26", n:1, title:"생성형 AI 로 콘텐츠를 만드는 실무와 창업 · 커리어 인사이트"}
    ],
    ...
    detail:`
## 초청 특강입니다
상지대학교 **문화콘텐츠학과** 요청으로 진행하는 특강입니다. 홈페이지에서 신청받는 강의가 아니라,
학과의 초청을 받아 나가는 자리입니다.

## 무엇을 이야기하나
- **현업의 생성형 AI** — 글 · 이미지 · 영상 콘텐츠를 실제로 AI 와 함께 만드는 방식
- **AI 로 창업하기** — 작은 브랜드와 1인 사업가가 AI 를 직원처럼 쓰며 일하는 구조
- **콘텐츠 분야의 일과 취업** — AI 가 들어온 실무 현장에서 어떤 역량이 요구되는지

직접 AI 로 콘텐츠를 만들고 사업을 운영하는 실무자의 시선으로, 학생들이 궁금해하는 지점을 짚습니다.
...
## 학교 · 기관 특강을 원하시면
학과 · 기관 단위로 따로 요청하실 수 있습니다. 대상과 원하시는 주제를 알려주시면
일정을 맞춰 보겠습니다.
`
  },
  {
    id:"cc-2", title:"클로드 코드 마스터클래스", edition:"2기", status:"auto", paid:true,
    host:"스몰브랜드설계자 · 프라이빗 유료 과정 · 정원 10명",
    summary:"챗GPT 창에 묻고 답하는 단계를 넘어, 내 컴퓨터 안에서 내 브랜드를 이해하고 일하는 AI 를 4시간에 세팅합니다. "
        + "브랜드 코어 설계, 비주얼 프로덕션, 카카오톡 자동 보고까지 완성합니다. 정원 10명 · 수강료 10만 원.",
    summaryHtml:"챗GPT 창에 묻고 답하는 단계를 넘어, <br class=\"m\">내 컴퓨터 안에서 내 브랜드를 이해하고 <br class=\"m\">일하는 AI 를 4시간에 세팅합니다.<br class=\"pc\"> "
    ...
    note:"접수하신 분께는 <b>개별 연락</b>을 드리며, <br class=\"m\">수강료 결제 안내도 그때 드립니다.",
    sessions:[
      {date:"2026-10-28", n:1, title:"환경 구축부터 자동 보고까지, 네 개의 모듈",
       titleHtml:"환경 구축부터 자동 보고까지, <br class=\"m\">네 개의 모듈",
       tag:"환경 구축 · 브랜드 코어 설계 · 비주얼 프로덕션 · 카카오톡 자동 보고",
       tagHtml:"환경 구축 · 브랜드 코어 설계 <br class=\"m\">· 비주얼 프로덕션 · 카카오톡 자동 보고",
       do:"내 브랜드를 이해하는 AI 를 세팅하고, 카드뉴스 한 세트와 카톡 보고 비서까지 완성합니다",
